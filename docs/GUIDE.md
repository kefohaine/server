...
|----------|-----------------------------------------|-----------|------------------------------|------------------------------|
| domain   | `services/domain/docker-compose.yml`    | `vhosts`  | `make d-restart-vhosts`      | `make recreate-vhosts` (builds `caddy-dns:local` from `services/domain/Dockerfile`) |
| cloud    | `services/cloud/docker-compose.yml`     | `nextcloud` | `make d-restart-nextcloud`  | `make recreate-nextcloud`    |
| share    | `services/share/docker-compose.yml`     | `share-flask` | `make d-restart-share-flask` | `make recreate-share-flask` |
| vault    | `services/vault/docker-compose.yml`     | `vaultwarden` | `make d-restart-vaultwarden` | `make recreate-vaultwarden` |
| kuma     | `services/kuma/docker-compose.yml`      | `ut-kuma` | `make d-restart-ut-kuma`     | `make recreate-ut-kuma`      |
