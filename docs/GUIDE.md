...
make d-restart-<ctn>   # restart every container in the compose file — after editing a mounted config; mc restarts the mc-server container, mc-web restarts the dashboard
