...
make mail-quota-add MAIL=name@fxmq.net QUOTA=2G  # set a mailbox storage quota (B/k/M/G/T suffix; 0 = no limit)
make mail-quota-del MAIL=name@fxmq.net # remove a mailbox quota (back to unlimited)
