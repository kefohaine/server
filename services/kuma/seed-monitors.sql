...
-- Apply with:
--   docker exec -i kuma sqlite3 /app/data/kuma.db < services/kuma/seed-monitors.sql
--
-- Adjust user_id (1) if your admin is not id=1
-- (check: docker exec kuma sqlite3 /app/data/kuma.db "SELECT id,username FROM user;").
--
