...
| www.fxmq.net      | Cloudflare (proxied) → VPS IP | Anyone on the internet             | Landing stub answering `ok` on `/`; Caddy file browser at `/download` over the `download/` drop folder |
