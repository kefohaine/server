    ...
    Public DNS ──► │            Cloudflare (proxy)               │
           ...
           ops / api          share / vault       cloud:9000
                     ...
                     └──────────────┬──────────────────────────────┘
                             ...
                             │  - address=/server.jehpok.com/100.81.245.77
...
| server.jehpok.com  | **Not in Cloudflare**       | Only devices on the Tailscale network       | Responds `ok`; admin UI for the shortener at `/share`; ttyd shell on the host at `/console` |
...
### Why Tailscale for server.jehpok.com
...
- That resolver must return `100.81.245.77` for `server.jehpok.com` and forward everything else.
