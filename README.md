    ...
    Public DNS ──► │            Cloudflare (proxy)               │
           ...
           ops / api          share / vault       cloud:9000
                     ...
                     └──────────────┬──────────────────────────────┘
                             ...
                             │  - address=/ops.jehpok.com/100.81.245.77
...
### Why Tailscale for ops.jehpok.com
...
- That resolver must return `100.81.245.77` for `ops.jehpok.com` and forward everything else.
