...
>@echo ""
>@echo "  Global"
>@echo "  │  make migrate          │to another server"
>@echo "  │  │    deploy           │config/ to this server"
>@echo "  │  │    update           │[apt -> update/upgrade; docker -> pull/recreate]"
>@echo "  │  │    backup           │[all container databases & secrets to homelab/backups/; server config to homelab/repo/]"
>@echo "  │  │    cleanup          │[apt -> autoremove/clean; docker -> prune builder/images/containers; backups -> keep latest 3 of each]"
>@echo "  └  └    status           │list [git; systemd; docker; tmux; backups; mails]"
>@echo ""
>@echo "  GitHub Actions"
>@echo "  │  make git-pull         │pull remote changes        │"
>@echo "  │  │       -add          │stage changes"             │"
>@echo "  │  │       -com MSG=     │commit staged changes      │MSG= required commit message"
>@echo "  └  └       -push         │push committed changes     │"
>@echo ""
>@echo "  Systemd Services"
>@echo "  │  make systemd-restart  │restart host target        │for one specific service, append -<service> / for all known services, append -all"
>@echo "  └  └           -log      │tail target journal"       │for one specific service, append -<service> / for all known services, append -all"
>@echo ""
>@echo "  Docker Containers"
>@echo "  │  make dok-recreate     │force-recreate target"
>@echo "  │  make dok-restart      │restart target"
>@echo "  │  make dok-stop         │stop target"
>@echo "  │  make dok-log          │tail target logs"
>@echo "  │  Variables"
>@echo "  │    -<container>        │one specific container"
>@echo "  └    -all                │all known containers"
>@echo ""
>@echo "  Tmux Sessions"
>@echo "  │  make tmux-new NAME=   │create detached target"
>@echo "  │  make tmux-open NAME=  │attach to target"
>@echo "  │  make tmux-kill NAME=  │kill target"
>@echo "  │  Variables"
>@echo "  │    NAME=               │session name; required"
>@echo "  │  Shortcuts"
>@echo "  └    Ctrl + B + D        │detach from target"
>@echo ""
>@echo ""
>@echo ""
>@echo ""
