...
>@echo "  │  │       -com MSG=     │commit staged changes"
>@echo "  │  └       -push         │push committed changes"
>@echo "  │  Variables"
>@echo "  └  └  MSG=               │commit message; required"
>@echo ""
>@echo "  Systemd Services"
>@echo "  │  make systemd-restart  │restart host target" 
>@echo "  │  └           -log      │tail target journal"
>@echo "  │  Variables"
>@echo "  │  │  -<service>         │one specific service"
>@echo "  └  └  -all               │all known services"
>@echo ""
