...
>@echo "    make git-add       stage edits"
>@echo "    make git-com MSG=  commit staged edits"
>@echo "    make git-push      push committed edits"
>@echo "  Variables"
...
>@echo ""
>@echo ""
>@echo ""status for each category & in one command
>@echo ""
...
>@echo ""
>@echo "  Tmux sessions"
>@echo "    make tmux-new NAME=    create detached session <n>"
>@echo "    make tmux-open NAME=   attach to session <n> (Ctrl-b d to detach)"
>@echo "    make tmux-kill NAME=   kill session <n>"
>@echo ""
>@echo "  Junk Cleanup"
